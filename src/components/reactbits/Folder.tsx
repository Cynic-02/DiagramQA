...
/**
 * Folder — an interactive skeuomorphic folder that opens to fan out up to
 * three "papers." Used narrowly in this app for the ResultsStage sidebar,
 * where its literal metaphor (a folder holding output documents) matches
 * the actual action available there: downloading the verified Q&A set.
 */
