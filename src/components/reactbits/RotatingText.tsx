...
/**
 * RotatingText — cycles through a list of strings with a per-character
 * stagger transition. Ported to `framer-motion` (already a project
 * dependency) instead of the upstream `motion/react` import.
 */
