  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        "placeholder:text-muted-foreground flex field-sizing-content min-h-16 w-full rounded-[var(--radius-input,10px)] border-[length:var(--border-w-input,2px)] border-[var(--line)] px-3 py-2 text-base font-medium transition-[box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
