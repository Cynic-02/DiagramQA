...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "flex h-11 w-full min-w-0 border-2 border-[var(--ink)] bg-[var(--card)] px-3.5 py-2",
        ...
        "focus-visible:border-[3px] focus-visible:px-[13px] focus-visible:py-[7px] focus-visible:shadow-[4px_4px_0_var(--ink)]",
