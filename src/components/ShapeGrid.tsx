...
/* ============================================================
   ShapeGrid — animated canvas grid background (ported from React
   Bits, typed for this codebase). Replaces the static CSS grid-faint
   pattern on the homepage with a slowly moving grid, matching the
   direction requested for the homepage background.
   ============================================================ */
